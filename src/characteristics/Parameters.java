...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Stage6MainA"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Stage3SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
