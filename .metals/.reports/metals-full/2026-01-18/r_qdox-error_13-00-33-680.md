error id: file://<WORKSPACE>/src/algorithms/TeamASecondaryBotxxx.java
file://<WORKSPACE>/src/algorithms/TeamASecondaryBotxxx.java
...
```java
offset: 1
uri: file://<WORKSPACE>/src/algorithms/TeamASecondaryBotxxx.java
text:
```scala
s@@rc/algorithms/TeamAMainBotXXX.java
```
...
QDox parse error in file://<WORKSPACE>/src/algorithms/TeamASecondaryBotxxx.java