error id: file://<WORKSPACE>/src/algorithms/TeamAMainBotXXX.java:algorithms/TeamAMainBotXXX#sendLogMessage#
file://<WORKSPACE>/src/algorithms/TeamAMainBotXXX.java
empty definition using pc, found symbol in pc: algorithms/TeamAMainBotXXX#sendLogMessage#
...
sendLogM@@essage("[CIRCLE] Moving toward enemy");
}
    ...
    private void handleMessages() {
        ...
        for (String msg : messages) {
            ...
            if (msg.contains("ENEMY")) {
                ...
                targetEnemyX = Double.parseDouble(parts[3]);
                targetEnemyY = Double.parseDouble(parts[4]);
                enemyKnown = true;
            
                log("Received enemy position from Scout: (" +
                    (int) targetEnemyX + ", " + (int) targetEnemyY + ")");
            
                if (!isLeader) {
                    state = State.JOIN_CIRCLE;
                    log("Switching to JOIN_CIRCLE");
                }
            }
