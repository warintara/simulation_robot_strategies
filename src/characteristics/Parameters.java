...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.TeamAMainBotXXX"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamAMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             t4amAMainBot3InitHeading = EAST; //clockwise trigonometric unit, according to screen pixel coordinate reference

  public static final String teamASecondaryBotBrainClassName = "algorithms.ScoutSecondaryBot"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.TeamAMainBotXXX"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.ScoutSecondaryBot"; //class given by name; is supposed to extends robotsimulator.Brain
