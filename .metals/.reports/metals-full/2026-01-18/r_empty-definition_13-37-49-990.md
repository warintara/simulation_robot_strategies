error id: file://<WORKSPACE>/src/algorithms/TeamAMainBotXXX.java:java/lang/Math#sin().
file://<WORKSPACE>/src/algorithms/TeamAMainBotXXX.java
empty definition using pc, found symbol in pc: java/lang/Math#sin().
...
public class TeamAMainBotXXX extends Brain {
    ...
    public void step() {
        ...
        if (turnTask) {
            if (Math.abs(Math.s@@in(getHeading() - targetHeading))
