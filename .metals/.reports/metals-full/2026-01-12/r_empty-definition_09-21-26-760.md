error id: file://<HOME>/T%C3%A9l%C3%A9chargements/simovies20251201/src/algorithms/TeamAMainBotXXX.java:java/util/ArrayList#
...
public class TeamAMainBotXXX extends Brain {
    ...
    private void circleEnemy() {
        ...
        if (distance < 600) {
            moveBack();
            sendLogMessage("[CIRCLE] Too close, backing off");
            return;
        }
    ...
    private void handleMessages() {
        Ar@@rayList<String> messages = fetchAllMessages();
